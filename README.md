...
<html>
    <head>
      ...
      .image {
        ...
        background: url("https://i0.wp.com/www.xyruscode.com/wp-content/uploads/2021/09/xyrus.png?w=471&ssl=1") center center no-repeat;
       ...
       <body>
         <div class="box">
          <div id="overlay">
            ...
            <ul class="text">Prince Shammah</ul>
            <div class="text1">Web + Android</div>
          ...
          <div class="panel-heading " role="tab" id="headingOne">
            <h4 class="panel-title ">
              <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="" aria-controls="collapseOne">
                <div class="title  btn btn-danger btn-outline btn-lg">ABOUT PRINCE</div>
              </a>
            </h4>
          </div>
